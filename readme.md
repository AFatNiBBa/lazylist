...
- **`traverse`**: For each element yields the element and the children generated by a provided function and does it all again for each child
...
- **`insert`**: Adds a value to the specified index of the current list
- **`prepend`**: Adds a value to the beginning of the current list
- **`append`**: Adds a value to the end of the current list
- **`remove`**: Removes the first `n` occurrences of a value from the list
